---
title: "Developer Workflows mit Clawdbot: AI-Assistenz über WhatsApp, Telegram & Co."
description: "Clawdbot verbindet deine Messaging-Apps mit AI Coding Agents. Setup, Konfiguration und praktische Workflows für den Entwickleralltag."
date: 2026-01-26
lang: de
slug: developer-workflows-clawdbot
published: true
---

[Clawdbot](https://github.com/clawdbot/clawdbot){target="_blank"} ist eine Open-Source-Bridge zwischen Messaging-Apps und AI Coding Agents. Du schickst eine Nachricht über WhatsApp, Telegram, Discord oder iMessage - und bekommst eine Antwort von einem AI-Agenten, der auf deine lokalen Projekte zugreifen kann.
...
## Was Clawdbot ist (und was nicht)

Clawdbot ist kein weiterer AI-Chatbot. Es ist eine **Bridge** - ein Gateway, das zwischen deinen Messaging-Apps und AI-Agenten vermittelt. Der Agent selbst ist Pi, ein Coding-Assistant, der über RPC angebunden ist und Zugriff auf deine lokalen Projekte haben kann.
...
Seit das Projekt auf X viral ging, kursiert die Empfehlung, man brauche einen Mac Mini oder VPS dafür. [Grok hat das verbreitet](https://x.com/grok/status/2015215402737930598){target="_blank"} - und es ist Unsinn. Clawdbot läuft auf jedem Rechner mit Node.js 22. Dein Laptop reicht völlig.
...
Ab jetzt erreichst du deinen AI-Assistenten über deine normalen Chat-Apps. Die Konfiguration liegt in `~/.clawdbot/clawdbot.json` und lässt sich granular anpassen - welche Kontakte zugelassen sind, wie Gruppen behandelt werden, ob Mentions erforderlich sind.
...
Clawdbot ersetzt Claude nicht - es nutzt Claude (oder andere AI-Modelle) als Backend. Der Unterschied liegt im Interface und der Integration:
...
Clawdbot glänzt bei Situationen, in denen du mobil bist oder nebenbei arbeitest.
...
**Debugging-Kontext sammeln**: Wenn ein Bug auftritt, kannst du Screenshots, Fehlermeldungen oder Log-Ausschnitte direkt an den Assistenten schicken. Clawdbot unterstützt Bilder, Audio und Dokumente - der Agent sieht, was du siehst.
...
Clawdbot ist nicht nur für manuelle Interaktion gedacht. Mit Webhooks und Cron-Jobs lassen sich automatisierte Workflows bauen.
...
Clawdbot läuft überall dort, wo Node.js läuft:
...
Clawdbot ist kein Ersatz für eine vollwertige IDE mit AI-Integration. Für tiefgreifendes Refactoring oder komplexe Multi-File-Änderungen ist ein Desktop-Setup mit Cursor oder Claude Code besser geeignet.
...
Clawdbot löst ein Problem, das ich vorher nicht klar benennen konnte: Die Lücke zwischen "ich hab eine Coding-Frage" und "ich setze mich an den Rechner". Diese Lücke ist jetzt geschlossen.
...
Alle Infos zum Setup findest du in der [offiziellen Dokumentation](https://docs.clawd.bot/){target="_blank"} und auf [GitHub](https://github.com/clawdbot/clawdbot){target="_blank"}.
